...
<html lang="en">
  ...
  <body style="background:url('images/trainer2.jpg'); background-size: cover;">
    <div class="container-fluid" style="margin-top:60px;margin-bottom:60px;color:#34495E;">
      <div class="row">
        <div class="col-md-1"></div>
        <div class="col-md-4">
          <div class="card">
            <img src="images/trainer.jpg" class="card-img-top">
            <div class="card-body">
              <center>
              <h5>Trainer Login</h5><br>
              <form class="form-group" method="POST" action="loginprocess.php">
                <div class="row">
