  ...
  if(isset($_REQUEST['rSignup'])){
    ...
    if(($_REQUEST['rName'] == "") || ($_REQUEST['rEmail'] == "") || ($_REQUEST['rPassword'] == "")){
      ...
      if($result->num_rows == 1){
        ...
        $sql = "INSERT INTO requesterlogin_tb(r_name, r_email, r_password, r_contact) VALUES ('$rName','$rEmail', '$rPassword', '$rcontact')";
  ...
  <div class="row mt-4 mb-4">
    <div class="col-md-6 offset-md-3">
      <form action="" class="shadow-lg p-4" method="POST">
        ...
        <div class="form-group">
          <i class="fas fa-user"></i><label for="contact" class="pl-2 font-weight-bold">contact</label><input type="contact"
            class="form-control" placeholder="contact" name="$rcontact">
        </div>
